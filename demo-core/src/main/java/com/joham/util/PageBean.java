...
public class PageBean {
    ...
    public int getTotalPages() {
        totalPages = getRows() % pageSize == 0 ? rows / pageSize : rows
                / pageSize + 1;
        return totalPages;
    }
    ...
    /**
     * 获取显示的开始页码数与 @see {@link com.joham.util.PageBean#getEnd()} 相对存在
     *
    ...
    /**
     * 获取显示的结束页码数 {@link com.joham.util.PageBean#getStart()}
     * 
     * @return 结束的页码数
     */
    public int getEnd() {
